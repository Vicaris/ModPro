...
- You want to automatize tedious tasks, like title insertions tracking objects, cuting scenes, making fin credits, subtitles, etc...
...
You will also find a few advanced goodies in ``moviepy.video.tools`` to track objects in a video, draw simple shapes and color gradients (very useful for masks), generate subtitles and fin credits, etc. See :ref:`advancedtools` for a description of these.
